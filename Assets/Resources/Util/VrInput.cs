...
public class VrInput : MonoBehaviour {
    ...
    public static bool controllersFound { get { return leftController.isActiveAndEnabled && rightController.isActiveAndEnabled && leftController && SteamVR.connected[0] && SteamVR.connected[1]; } }
